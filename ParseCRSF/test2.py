...
parser.add_argument('-P', '--port', default='/dev/cu.usbserial-1110', required=False)
            ...
            if expected_len > 64 or expected_len < 4:
                ...
                if not crsf_validate_frame(single): # single[-1] != crc:
                    ...
                    packet_types = {
                        ...
                        0x17: PacketHandlers.handle_subsetrcchannelspacked_packet,
                        ...
                        0x2B: PacketHandlers.handle_parametersettingentry_packet,
